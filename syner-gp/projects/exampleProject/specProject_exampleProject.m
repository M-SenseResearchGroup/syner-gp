...
projectNotes = {'-project notes are a field in the synergp session struct.',...
                ...
                '-all projects must be stored in the syner-gp/projects folder corresponding a folder named with the same name as the project (e.g. syner-gp/projects/exampleProject',...
